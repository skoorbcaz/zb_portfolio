...
export class Slide {
  ...
  constructor(DOM_el) {
    ...
    this.DOM.logoImage = this.DOM.el.querySelector('.item-logo')
    this.DOM.description = this.DOM.el.querySelector('.description')
    this.DOM.detailsLink = this.DOM.el.querySelector('.details-link')
  }
}
