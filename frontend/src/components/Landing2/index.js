...
import { Avatar, Box, Center, Flex, Grid, Heading, Text } from '@chakra-ui/react'
...
import { DevShader } from './DevShader'
import { LandingHero } from './Hero'
import { DesignShader } from './DesignShader'
  ...
  return (
    <Layout>
      <div className='demo-4 '>
        ...
        <div className='landing-about-section'>
          <section className='dev-section about-section' style={{ background: 'var(--chakra-colors-gray-900)' }}>
            <div className='dev-section__inner'>
              <Box p={100}>
                <Heading fontSize='10em' className='content__title' data-splitting='' data-effect13=''>
              ...
              <Flex px={100}>
                ...
                <Flex style={{ flex: 1 }}>
                  ...
                  <Text style={{ fontSize: '2.5em' }} className='dev-about-desc' data-effect4='' data-splitting=''>
          ...
          <div className='design-section about-section' style={{ paddingBottom: 200 }}>
            <Box p={100}>
              <Heading color='gray.700' fontSize='10em' className='content__title' data-splitting='' data-effect6=''>
            ...
            <Flex px={100}>
              ...
              <Flex className='design-about-desc' borderRadius={5} style={{ flex: 1 }}>
                ...
                <Text style={{ fontSize: '2.5em' }} color='gray.600' className='dev-about-desc'>
                  Through a deep understanding of design principles and a passion for pushing boundaries, I deeply enjoy
                  the opportunity to unleash the power of creativity in software development.
                </Text>
              </Flex>
            </Flex>
          ...
          <section className='leadership-section about-section' style={{ paddingBottom: 200 }}>
            <Box p={100}>
              <Heading color='gray.800' fontSize='10em' className='content__title' data-splitting='' data-effect3=''>
            ...
            <Flex px={100}>
              ...
              <Flex style={{ flex: 1 }}>
                ...
                <Text color='gray.700' style={{ fontSize: '2.5em' }} className='dev-about-desc'>
                  The same passion that drives me to continually learn and grow as a developer and designer also fuels
                  me to invest in the growth of others. I love investing in those around me, and I am always looking for
        ...
        <section>
          <Flex>
            <Flex
              ...
              flex={1}
              h={300}
              style={{ borderRight: 'solid 1px', borderTop: 'solid 1px', color: 'var(--chakra-colors-gray-800)' }}
            >
        ...
        <section style={{ height: '200vh' }} className='landing-blog-section'>
          <div style={{ display: 'flex', position: 'relative' }}>
            <div className='blog-image-container' style={{ position: 'relative', height: '100vh', width: '100vw' }}>
              <Heading style={{ top: '5vh', left: '10%', fontSize: '3.6vw', position: 'absolute', width: '38vw' }}>
                8 Ways To Write Better React Today Friends
              </Heading>
              <Text style={{ bottom: '5vh', left: '10%', fontSize: '1.5vw', position: 'absolute', width: '33vw' }}>
                I love to create things and show people so that they can digest the amazingness.
              </Text>
              <div
                style={{
                  height: '100vh',
              ...
              >
                <Flex bg='white' borderRadius='100px' p={4} style={{ position: 'absolute', top: 15, right: 15 }}>
                  <Avatar icon={<BsArrowRightCircle />} />
                  <Heading color='gray.800' size='m' fontWeight={400}>
                    by <b>Zac Brooks</b>
                  </Heading>
                </Flex>
              </div>
...
const BlogImagemMaskSVG = () => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg'>
      <clipPath id='clipping' clipPathUnits='objectBoundingBox'>
        <path d='M0.689,0.023 C0.689,0.01,0.702,0,0.717,0 H0.972 C0.987,0,1,0.01,1,0.023 V0.977 C1,0.99,0.987,1,0.972,1 H0.72 C0.704,1,0.692,0.99,0.692,0.977 V0.915 C0.692,0.902,0.679,0.892,0.664,0.892 H0.028 C0.012,0.892,0,0.881,0,0.868 V0.312 C0,0.309,0.001,0.306,0.002,0.303 C0.001,0.301,0,0.298,0,0.295 V0.204 C0,0.191,0.012,0.181,0.028,0.181 H0.452 C0.472,0.181,0.487,0.168,0.487,0.152 V0.113 C0.487,0.1,0.5,0.089,0.515,0.089 H0.654 C0.673,0.089,0.689,0.076,0.689,0.06 V0.023' />
      </clipPath>
    </svg>
  )
}
const BlogSmallCard = () => {
  return (
    <div style={{ height: '48%', width: '400px', display: 'flex', flexDirection: 'column', paddingBottom: '4em' }}>
      <div
        className='blog-right-column__inner'
        style={{
          backgroundImage: `url(${img1})`,
          flex: 1,
          borderRadius: '3%',
      ...
      />
      <Text style={{ marginBottom: '1em', color: 'var(--chakra-colors-gray-500)', minWidth: '400px' }}>
        USER EXPERIENCE
      </Text>
      <Heading
        as='h3'
        style={{ textAlign: 'left', fontSize: '1.5rem', fontWeight: 600 }}
        className='text-animation-content__title'
        data-splitting=''
        data-effect11=''
      >
        <span style={{ background: 'var(--chakra-colors-gray-800)', minWidth: '400px' }} className='font-3 font-height'>
          What You Do When <br /> You Don't Know What To Do
        </span>
      </Heading>
    </div>
  )
...
const PortfolioHorizontalScroll = () => {
  return (
      ...
      <div className='track'>
        <div className='track-flex'>
          <div className='panel-wide'>
            <img
              className='image'
              src='https://assets.website-files.com/62f4dd003ef1495b1bb8f3a0/62f4f620fe7a4e4395360bc5_and-machines-mAiFQrt9xMc-unsplash.jpg'
              alt=''
            />
          </div>
          <div className='panel-wide'>
            <img
              className='image'
              src='https://assets.website-files.com/62f4dd003ef1495b1bb8f3a0/62f4f6201cd426577274fab1_and-machines-SZd_V4A8gYo-unsplash.jpg'
              alt=''
            />
          </div>
          <div className='panel-wide'>
            <img
              className='image'
              src='https://assets.website-files.com/62f4dd003ef1495b1bb8f3a0/62f4f62034d6a56dd03cced8_and-machines-odNU0f3jmUg-unsplash.jpg'
              alt=''
            />
          </div>
          <div className='panel-wide'>
            <img
              className='image'
              src='https://assets.website-files.com/62f4dd003ef1495b1bb8f3a0/62f4f620dbc7f7e7db222488_and-machines-YLplJ9m_RKE-unsplash.jpg'
              alt=''
            />
          </div>
          <div className='panel-wide'>
            <img
              className='image'
              src='https://assets.website-files.com/62f4dd003ef1495b1bb8f3a0/62f4f62054964a1416e0b3c8_and-machines-vqTWfa4DjEk-unsplash.jpg'
              alt=''
            />
          </div>
        </div>
