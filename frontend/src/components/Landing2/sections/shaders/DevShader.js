...
import abstractSVG from '../../../../images/zb-icon.png'
extend({ SSAOPass })
...
export const DevShader = () => {
  return (
    <Canvas style={{ opacity: 1 }} shadows dpr={[1, 2]} camera={{ position: [0, 0, 20], fov: 35, near: 1, far: 40 }}>
...
function Clump({ mat = new THREE.Matrix4(), vec = new THREE.Vector3(), ...props }) {
  const texture = useTexture(abstractSVG)
